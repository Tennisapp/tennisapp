...
public class TournamentServiceImpl implements TournamentService{
	...
	public boolean getTournamentPublishMethod(int tournamentId) {
		// TODO Auto-generated method stub
		return tournamentDao.getTournamentPublishMethod(tournamentId);
	}
	...
	public TournamentList getMyTournamentDetails(int orgId, int tournId) {
		// TODO Auto-generated method stub
		return tournamentDao.getMyTournamentDetails(orgId, tournId);
	}

	@Override
	public String setActiveOrInActiveTournament(int tournamentId, int activeVal) {
		// TODO Auto-generated method stub
		return tournamentDao.setActiveOrInActiveTournament(tournamentId,  activeVal);
	}

	@Override
	public OrganizerSettings getOrganizerSettings(int organizerId) {
		// TODO Auto-generated method stub
		return tournamentDao.getOrganizerSettings(organizerId);
	}

	@Override
	public String updateOrganizerDetails(JSONObject payload) {
		// TODO Auto-generated method stub
		return tournamentDao.updateOrganizerDetails(payload);
	}
