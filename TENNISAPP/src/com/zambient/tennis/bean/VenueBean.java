...
public class VenueBean implements Serializable{
	...
	private String venue_loc_coordinate;
	...
	public String getVenue_loc_coordinate() {
		return venue_loc_coordinate;
	}
	public void setVenue_loc_coordinate(String venue_loc_coordinate) {
		this.venue_loc_coordinate = venue_loc_coordinate;
	}
