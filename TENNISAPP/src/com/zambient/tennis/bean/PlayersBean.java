...
public class PlayersBean implements Serializable{
	...
	public String toString() {
		return "PlayersBean [name=" + name + ", dateOfBirth=" + dateOfBirth + ", address=" + address + ", addressLine2="
				+ addressLine2 + ", lavel=" + lavel + ", phone=" + phone + ", email=" + email + ", pwd=" + pwd
				+ ", repwd=" + repwd + ", itaId=" + itaId + ", itaRank=" + itaRank + ", gender=" + gender + ", points="
				+ points + ", rank=" + rank + ", age=" + age + ", playerId=" + playerId + ", playerAge=" + playerAge
				+ ", registeredBy=" + registeredBy + ", paymentId=" + paymentId + ", playerId2=" + playerId2
				+ ", playerRegBy=" + playerRegBy + ", selected=" + selected + ", tournamentId=" + tournamentId
