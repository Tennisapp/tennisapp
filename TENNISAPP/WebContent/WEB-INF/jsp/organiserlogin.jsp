...
<body class="whitebackground" ng-app="myApp" ng-controller="myCtrl" onload="initialize()">
<div class="maincolor">
  <header id="header">
...
<div class="container centredisplay">
	...
	<div ng-show="signUpTab">
            <form ng-submit="validateAddOrganiser()" name="organiserAdd" ngNativeValidate>
			   ...
			   <textarea type="text" id="autocomplete" onFocus="geolocate()"  ng-model="orgAddress2" name="orgAddress2" class="md-textarea form-control" rows="1" ng-maxlength="210" required="required" autocomplete="off"></textarea>
			   </div>
			   <span class="redcolor" style="font-size: .8em;" ng-show="organiserAdd.orgAddress2.$dirty&&organiserAdd.orgAddress2.$error.maxlength">Address must not exceed 210 characters!</span>
			   <br>
