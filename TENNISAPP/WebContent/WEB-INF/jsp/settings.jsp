	       ...
	       <div class="row">
	        ...
	        <div class="row">
			   ...
			   <div class="col-sm-6"> 
					...
					<input type="text" id="dateOfBirth" ng-model="dateOfBirth" class="form-control" required="required" ng-click="registerPlyrValidate = null" autocomplete="off" ng-disabled="true">
					</div>
				    <div class="col-sm-6"> 
				    <label for="address">RANKING</label>
				    <select ng-model="rankItem" ng-options="rankdata.rankId as rankdata.rankName for rankdata in rankList"  class="form-control" name="rankItem" id="rankid" style="border-radius: 0px;background: transparent;border: 1px solid #ccc;" autocomplete="off">
		            </select>
					</div>
			   </div>
			    <div class="" ng-if="rankItem != 1">
			      <div class="row">
					  <div class="col-sm-6"> 
			...
			<input type="text" id="name" class="form-control" ng-model="gender" name="name" maxlength="20" required="required" autocomplete="off" ng-click="registerPlyrValidate = null" ng-disabled="true">
	       </div>
					  </div>
					  <br>
...
<a href="#" class="back-to-top"><i class="fa fa-chevron-up"></i></a>
  ...
  <script  src="resources/javascript/custom/settings.js" ></script>
