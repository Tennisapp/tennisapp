...
<body class="section-bg" ng-app="myApp" ng-controller="myCtrl" ng-init="init()" style = "font-family: 'Montserrat', sans-serif;" onload="initialize()">
<input id="coordinate" hidden/>
<div class="section-bg">
  <header id="header" style ="background: rgba(0, 0, 0, 0.9);">
   ...
   <main id="main" style="margin-top: 120px;display: none;" >
    <section >
     ...
     <div class="container">
       <h3 class="section-title" style="color: #000;display: inline;">CREATE EVENT</h3>
       <hr>
     </div>     
...
<!-- <div class="breadcrump" style="color:#18d26e" >
 ...
 <div class="row">
	...
	<div class="col-sm-12" ng-show="show==0">
	     ...
	     <div ng-show="place === 'newCourt'">
	      ...
	      <div class="col-sm-6" style="float: left;">
           ...
           <div id="locationField">
                   <textarea id="autocomplete" placeholder="Enter your address" onFocus="geolocate()" type="text" ng-model="venueAddress2" name="venueAddress2" class="md-textarea form-control" rows="1" ng-maxlength="210" required="required"></textarea>
         </div>
               <span style="color:Red;font-size: .6em;" ng-show="academyAdd.venueAddress2.$dirty&&academyAdd.venueAddress2.$error.maxlength">Address must not exceed 210 characters!</span>
       ...
       <form ng-submit="validateTournament()" name="createTournament" ngNativeValidate>
	       ...
	       <div class="col-sm-6" style="float: left;">
			...
			<div class="">
				...
				<p id="selectedList" style="font-size: 12px;font-weight: 500;color:#18d26e;"></p>
         ...
         <form ng-submit="postTournament()">
				<ul class="w3-ul" id="shiva" style="list-style-type: none;"> 
				 <li ng-repeat="x in buildCourt" style="width:100%;">
					 ...
					 <div>
					 <label style="font-weight: 500;color: #000;">{{x.category_name}}</label>
					 </div>
					 <div class="col-sm-6" style="float: left;"> 
