      ...
      <nav id="nav-menu-container">
        ...
        <li><a href="organiserlogin" style="padding: 5px 10px 6px 10px;">Organizer</a></li>
		  ...
		  <c:if test="${sessionScope['scopedTarget.userSession'].loginType == 0}">
		   ...
		   <input type="hidden" name="popupmsg" id="playerId" value="${sessionScope['scopedTarget.userSession'].playerId}" />
		 </c:if>
        </ul>
    ...
    <section id="portfolio"  class="section-bg" >
      <div class="container">
        ...
        <div class="row portfolio-container" ng-if="!liveOrUpcoming">
           <div class="col-lg-4" ng-repeat="list in liveTournaments | limitTo:6">
           <a href="redirectToShowTournament?tournamentId={{list.tournamentId}}"  ng-click="globalTournament(list.tournamentId)">
              <div class="singtournment">
                  <b style="font-size: 12px;color: #18d26e;">{{list.tournamentStartDate}}</b><br>
                  <b style="font-size: 14px;color: #000;">{{list.title | uppercase}}</b>
        ...
        <div class="row portfolio-container" ng-if="liveOrUpcoming">
          <div class="col-lg-4" ng-repeat="list in upcommingTournaments | limitTo:6">
          <a href="redirectToShowTournament?tournamentId={{list.tournamentId}}"  ng-click="globalTournament(list.tournamentId)">
              <div class="singtournment">
                  <b style="font-size: 12px;color: #18d26e;">{{list.tournamentStartDate}}</b><img src="resources/images/checkmark.png" style="width: 20px;float: right;" ng-if="checkTournReg(list.tournamentId) == true"><br>
                  <b style="font-size: 14px;color: #000;">{{list.title |uppercase}}</b>
                  <p style="font-size: 13px;color: #000;">{{list.venueName}}</p>
                  <br>
	       ...
	       <div class="row">
	        ...
	        <div class="row">
				...
				<div class="row">
                   ...
                   <textarea type="text" id="autocomplete" placeholder="Enter your address" onFocus="geolocate()"  ng-model="address2" name="address2" class="md-textarea form-control" rows="1" ng-maxlength="210" required="required" autocomplete="off"></textarea>
