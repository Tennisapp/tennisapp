...
$scope.validateAddVenue = function(){
	...
	var venueAddress2=$("#autocomplete").val();
	
	//Google map longitude and latitude 
	var coordinates=$("#coordinate").val();
	...
	if(venueAddress2 == "" || venueAddress2 == undefined){
		$scope.errormsg = "Address should not be empty...";
		$("#danger-alert").fadeIn(1000);
  	    setTimeout(function(){ $("#danger-alert").fadeOut(1000) }, 3000);
		return false;
	...
	formData.append('venueAddress2',venueAddress2);
	...
	$.ajax({
        ...
        success: function(data){
            ...
            if(data > 0){
            	...
            	window.location.href = "redirectToOrgTournamentView?tournamentId="+$scope.tournamentId;
            }else{
            	$("#wait").css("display", "none");
